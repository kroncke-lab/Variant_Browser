...
MIDDLEWARE = [
    ...
    'variantbrowser.middleware.BlockBotsMiddleware',
...
# to avoid 500 errors when static files are missing from the manifest
...
LOGGING = {
    ...
    'filters': {
        'suppress_health_checks': {
            '()': 'variantbrowser.middleware.SuppressHealthCheckLogsFilter',
        },
    },
    'formatters': {
        'verbose': {
